...
export var customerRoute = express.Router();
customerRoute.post('/', function(req, res) {
    return _async_to_generator(function() {
        var usecase, customerDto, ouput, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    usecase = new CreateCustomerUseCase(new CustomerRepository());
                    _state.label = 1;
                case 1:
                    _state.trys.push([
                        1,
...
customerRoute.get('/', function(req, res) {
    return _async_to_generator(function() {
        var usecase, output, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    usecase = new ListCustomerUseCase(new CustomerRepository());
                    _state.label = 1;
                case 1:
                    _state.trys.push([
                        1,
