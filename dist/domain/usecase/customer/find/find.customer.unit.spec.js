...
var address = new Address("Street 1", 9781, "Zipcode1", "City 1");
...
describe("Test find customer use case", function() {
    ...
    it("should find a customer", function() {
        return _async_to_generator(function() {
            var customerRepository, usecase, input, output, result;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
    ...
    it("should throw an error when customer is not found", function() {
        return _async_to_generator(function() {
            var customerRepository, usecase, input;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        customerRepository = MockRepository();
                        customerRepository.find.mockImplementationOnce(function() {
...
//# sourceMappingURL=find.customer.unit.spec.js.map