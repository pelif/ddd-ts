...
describe("Costumer unit test", function() {
    it("Should throw error when id is empty", function() {
        expect(function() {
            var cust = new Customer('', "Felipe Dani");
        }).toThrowError("Id is required");
    });
    it("Should throw error when name is empty", function() {
        expect(function() {
            var cust = new Customer('12345', "");
        }).toThrowError("Name is required");
    });
    it("Should change name", function() {
        var customer = new Customer("123", "Rafael Daniel");
    ...
    it("Should activate customer", function() {
        ...
        var address = new Address("Street 1", 123, '04195120', 'São Paulo');
...
//# sourceMappingURL=costumer.spec.js.map